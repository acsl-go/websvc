...
type Config struct {
	...
	CACert         string `mapstructure:"ca_cert" json:"ca_cert" yaml:"ca_cert"`                            // [Optional] CA Certificate file path for verifying client certificates, only used when SSL is enabled
